...
mod platform {
    ...
    #[cfg(not(any(target_os = "android", target_os = "redox", target_os = "solaris", all(target_os = "horizon", target_arch = "aarch64"))))]
    #[inline]
    unsafe fn aligned_malloc(layout: &Layout) -> *mut u8 {
    ...
    //TODO: Why isnt posix_memalign linked correctly?
